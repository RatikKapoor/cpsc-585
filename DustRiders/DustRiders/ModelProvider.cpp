...
void ModelProvider::initialize(RenderingSystem &renderer)
{
	...
	rock1 = renderer.loadModelFromFile("TestRock", "./assets/models/crystals.obj");
	rock2 = renderer.loadModelFromFile("TestRock", "./assets/models/crystals.obj");
	rock3 = renderer.loadModelFromFile("TestRock", "./assets/models/crystals.obj");
