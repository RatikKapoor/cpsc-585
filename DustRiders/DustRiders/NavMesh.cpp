...
NavMesh::NavMesh() {
	...
	glm::vec3 v1 = glm::vec3(18, 102.5, 252);
	glm::vec3 v2 = glm::vec3(18, 102.5, 252);

	glm::vec3 v3 = glm::vec3(18, 102.5, 252);
	glm::vec3 v4 = glm::vec3(18, 102.5, 252);
	glm::vec3 v5 = glm::vec3(18, 102.5, 252);

	glm::vec3 v6 = glm::vec3(18, 102.5, 252);
	glm::vec3 v7 = glm::vec3(18, 102.5, 252);
	glm::vec3 v8 = glm::vec3(18, 102.5, 252);

	// [n4 / n5][n6 / n7]
	// [n0 / n1][n2 / n3]

	Node* n0 = new Node(0, v0, v3, v4);
	Node* n1 = new Node(0, v0, v1, v4);

	Node* n2 = new Node(0, v1, v4, v5);
	Node* n3 = new Node(0, v1, v2, v5);

	Node* n4 = new Node(0, v3, v7, v6);
	Node* n5 = new Node(0, v3, v4, v7);

	Node* n6 = new Node(0, v4, v8, v7);
	Node* n7 = new Node(0, v4, v5, v8);
